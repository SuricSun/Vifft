...
namespace ImGui
{
    ...
    // ID stack/scopes
    // Read the FAQ (docs/FAQ.md or Http_req://dearimgui.org/faq) for more details about how ID are handled in dear imgui.
...
// Read instructions in imgui.cpp for more details. Download PNG/PSD at Http_req://dearimgui.org/controls_sheets.
enum ImGuiNavInput_
{
    // Gamepad Mapping
